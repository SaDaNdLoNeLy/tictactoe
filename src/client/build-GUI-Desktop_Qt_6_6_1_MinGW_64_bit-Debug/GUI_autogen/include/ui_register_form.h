...
""));
        ...
        label->setGeometry(QRect(80, 50, 141, 41));
        QFont font;
...
"background: transparent;"));
        ...
        register_btn->setGeometry(QRect(30, 290, 240, 40));
...
"border-radius: 10px;"));
        ...
        label_2->setGeometry(QRect(70, 340, 161, 16));
        Login = new QPushButton(frame);
        Login->setObjectName("Login");
        Login->setGeometry(QRect(110, 360, 75, 24));
        Login->setFont(font);
        ...
        confirm_password->setGeometry(QRect(30, 230, 240, 30));
